...
const querry ="SELECT * FROM test1.robots"
// data of select    
function score (){
...
function affiche (a) {  
    fs.truncate('C:/Users/bouzi/Downloads/tt terrain/photo/affiche1.js', 0, (err) => {
        if (err) {
...
fs.readFile('C:/Users/bouzi/Downloads/tt terrain/photo/js.js', 'utf8', (err, data) => {
    if (err) {
    ...
    fs.writeFile('C:/Users/bouzi/Downloads/tt terrain/photo/affiche1.js', combinedData, 'utf8', (err) => {
        if (err) {
